...
```
npm create cloudflare@latest -- --template=cloudflare/templates/lydiahtml
```

A live public deployment of this template is available at [https://lydiahtml.templates.workers.dev](https://lydiahtml.templates.workers.dev)
